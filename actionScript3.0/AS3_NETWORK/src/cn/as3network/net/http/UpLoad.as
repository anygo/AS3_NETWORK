package cn.as3network.net.http
{
	...
	import cn.as3network.event.UploadEvent;
	...
	[Event(name="uploadFileSelected", type="cn.as3network.event.UploadEvent")]
	[Event(name="uploadFileError", type="cn.as3network.event.UploadEvent")]
	[Event(name="uploadFileComplete", type="cn.as3network.event.UploadEvent")]
	[Event(name="uploadFileUploadCompleteData", type="cn.as3network.event.UploadEvent")]
	[Event(name="uploadFileProgress", type="cn.as3network.event.UploadEvent")]
	 ...
	 * 
	 */	
	public class UpLoad extends EventDispatcher implements IDispose
	{
		 ...
		 * 
		 */	
		public function UpLoad(serverPathValue:String="", folderNameValue:String="", fileNameValue:String="")
		{
			super();
		...
		public function upLoad(file:FileReference=null):void
		{
			...
			request.url = encodeURI(_serverPath + "/Upload?folderName=" + _folderName +"&fileName=" + _fileName);
			try {
