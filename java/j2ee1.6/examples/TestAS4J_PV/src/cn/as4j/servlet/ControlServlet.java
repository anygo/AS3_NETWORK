...
import cn.as4j.bean.ContextUtil;
import cn.as4j.bean.IParamEncrypt;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
	{
		...
		try {	
			...
			if(contextUtil == null)
			{
				...
				if(outDecrypt == null)
					outDecrypt = contextUtil.getOuterEncrypt();
				if(outEncrypt == null)
			...
			if(outDecrypt != null)
				bdata = outDecrypt.decrypt(bdata);
